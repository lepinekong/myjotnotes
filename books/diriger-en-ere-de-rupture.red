Red [
    Title: "diriger-en-ere-de-rupture.red"
]

Journal: [

    Title: {J'ai lu: "Diriger en ère de rupture" (sur l'échec du logiciel LOUVOIS) 
    de Jean-Michel Palagos et Julia Maris}

    Source: [
        .title: {ReAdABLE Source}
        .text: {[http://myjotnotes.space/books/diriger-en-ere-de-rupture.red](https://github.com/lepinekong/myjotnotes/books/diriger-en-ere-de-rupture.red)
        }
        .Published-Url: http://myjotnotes.space/books/diriger-en-ere-de-rupture
    ]   
    
    Livre: [
        .title: "Sujet du livre:"
        .text: {
        ...
        .image: https://images-na.ssl-images-amazon.com/images/I/417UT9qFrOL._SX354_BO1,204,203,200_.jpg
        .text: {Blogs consacrés à Louvois}
        .links: [
            {lemamouth.blogspot.fr} http://lemamouth.blogspot.fr/search?q=Louvois
        ]
        .text: {Revues de l'ouvrage:}
        .links: [
        ...
        .links: [
            ...
            "Amazon.fr" https://www.amazon.fr/Diriger-%C3%A8re-rupture-Brouillard-solitude/dp/270569210X
        ]
    ]
